...
const MainContainer = () => {
  ...
  return (
    ...
    <section className="hero" id="top">
      <div className="hero-copy">
        <div className="hero-status">
          <i aria-hidden="true" />
          8× Hackathon &amp; Competition Winner
        </div>
        <p className="eyebrow">
        ...
        <div className="hero-lower">
          <p className="hero-now">
            Currently AI Product Engineer at Highview · San
      ...
      <div className="capability-track">
        {[0, 1].map((copy) => (
          <div aria-hidden={copy === 1} key={copy}>
            ...
            <span>Syndicate by Maximor · Tickmark</span><i />
          </div>
        ))}
      </div>
    </section>
    ...
    <section className="section archive-section" aria-labelledby="archive-title">
      ...
      <div className="award-ledger" aria-label="Eight award-winning projects">
