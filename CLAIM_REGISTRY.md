# Portfolio Claim Registry

Statuses:

- **Verified** — supported by the résumé or a linked public artifact.
- **Contextual** — safe only with the wording and limitations recorded here.
- **Pending** — do not publish until the missing method or evidence is attached.
- **Rejected** — superseded or inaccurate wording.

| ID | Approved public wording | Evidence | Ownership | Status |
| --- | --- | --- | --- | --- |
...
- The homepage uses verified claims only.
- A contextual claim may appear on a case-study page beside its limitation.
