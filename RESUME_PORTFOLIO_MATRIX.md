# Résumé / Portfolio Matrix

The résumé PDF is the canonical employment and education artifact. The portfolio can be more current for product work, but any difference must be deliberate.

| Topic | Résumé wording | Portfolio wording | Canonical rule |
| --- | --- | --- | --- |
